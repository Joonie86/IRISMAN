...
bool test_controlfan_compatibility()
{
    if(firmware == 0x341C || firmware == 0x355C || firmware == 0x355D || firmware == 0x355E ||
       ...
       firmware == 0x460C || firmware == 0x460D || firmware == 0x460E ||
       firmware == 0x465C || firmware == 0x465D || firmware == 0x466C || firmware == 0x466D ||
       firmware == 0x470C || firmware == 0x470D || firmware == 0x475C || firmware == 0x475D || firmware == 0x476C || firmware == 0x476D || firmware == 0x478E || firmware == 0x480C
      )
        return true;
    else
        return false;
...
int load_ps3_controlfan_payload()
{
    ...
    if(firmware == 0x341C) {        // firmware 3.41 2EB128
        ...
        ret = 1;
    }  else if((firmware == 0x475D) || (firmware == 0x476D) || (firmware == 0x478E)) { // firmware 4.75-4.76 dex / 4.78 DEH
        // enables sys_game_get_temperature
        lv2poke32(0x800000000000C728ULL, 0x38600000); // sys 383
        // enables sys_sm_get_fan_policy
        lv2poke32(0x8000000000009EB8ULL, 0x38600001); // sys 409
